...
namespace Datadog.Trace.Ci.Agent
{
    ...
    internal class CIAgentWriter : IEventWriter
    {
        ...
        public CIAgentWriter(ImmutableTracerSettings settings, ISampler sampler, int maxBufferSize = DefaultMaxBufferSize)
        {
            ...
            var api = new Api(settings.Exporter.AgentUri, apiRequestFactory, null, rates => sampler.SetDefaultSampleRates(rates), isPartialFlushEnabled, areTracerStatsEnabled);
