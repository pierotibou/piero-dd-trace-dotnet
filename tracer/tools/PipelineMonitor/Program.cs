...
try
{
    ...
    processor.Process();
    Console.WriteLine("Build " + buildId + " has been processed successfully. It should be visible at: https://dd-dotnet.datadoghq.com/apm/services/consolidated-pipeline/operations/ci_run/resources");
