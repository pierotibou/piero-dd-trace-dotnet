...
namespace Datadog.Trace.TestHelpers
{
    public abstract class TestHelper
    {
        ...
        protected void EnableTelemetry(bool enabled = true, int? standaloneAgentPort = null)
        {
            ...
            SetEnvironmentVariable("DD_TRACE_TELEMETRY_AGENTLESS_ENABLED", standaloneAgentPort.HasValue.ToString());

            if (standaloneAgentPort.HasValue)
            {
                SetEnvironmentVariable("DD_TRACE_TELEMETRY_URL", $"http://localhost:{standaloneAgentPort}");
