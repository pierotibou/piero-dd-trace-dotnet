...
namespace Datadog.Trace.Tests
{
    public class ApiTests
    {
        ...
        public async Task SendTraceAsync_200OK_AllGood()
        {
            ...
            var api = new Api(new Uri("http://127.0.0.1:1234"), apiRequestFactory: factoryMock.Object, statsd: null, updateSampleRates: null, isPartialFlushEnabled: false, areTracerStatsEnabled: false);
        ...
        public async Task SendStatsAsync_200OK_AllGood()
        {
            ...
            var api = new Api(new Uri("http://127.0.0.1:1234"), apiRequestFactory: factoryMock.Object, statsd: null, updateSampleRates: null, isPartialFlushEnabled: false, areTracerStatsEnabled: true);
        ...
        public async Task StatsHeader(bool tracerStatsEnabled)
        {
            ...
            var api = new Api(new Uri("http://127.0.0.1:1234"), apiRequestFactory: factoryMock.Object, statsd: null, updateSampleRates: null, isPartialFlushEnabled: false, areTracerStatsEnabled: tracerStatsEnabled);
        ...
        public async Task ExtractAgentVersionHeaderAndLogsWarning()
        {
            ...
            var api = new Api(new Uri("http://127.0.0.1:1234"), apiRequestFactory: factoryMock.Object, statsd: null, updateSampleRates: null, isPartialFlushEnabled: true, log: logMock.Object, areTracerStatsEnabled: false);
        ...
        public async Task SetsDefaultSamplingRates()
        {
            ...
            var api = new Api(new Uri("http://127.0.0.1:1234"), apiRequestFactory: factoryMock.Object, statsd: null, updateSampleRates: updateSampleRates, isPartialFlushEnabled: false, areTracerStatsEnabled: false);
        ...
        {
            var api = new Api(new Uri("http://127.0.0.1:1234"), apiRequestFactory: null, statsd: null, updateSampleRates: null, isPartialFlushEnabled: partialFlushEnabled, areTracerStatsEnabled: false);
